...
- Governance token ($ECS) for community-driven decision making
...
- Tiered voting system based on $ECS stake and lock-up duration
...
- Mainnet launch of $ECC and $ECS tokens
